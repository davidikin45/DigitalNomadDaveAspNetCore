...
namespace DND.Web.DynamicForms.Mvc.LookupTables.Api
{
    ...
    {
        public LookupTablesController(ILookupTableApplicationService service, IMapper mapper, IEmailService emailService, IUrlHelper urlHelper, ITypeHelperService typeHelperService, AppSettings appSettings)
