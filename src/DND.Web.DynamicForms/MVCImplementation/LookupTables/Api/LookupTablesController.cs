...
namespace DND.Web.DynamicForms.MVCImplementation.LookupTables.Api
{
    ...
    public class LookupTablesController : BaseEntityWebApiControllerAuthorize<LookupTableDto, LookupTableDto, LookupTableDto, LookupTableDeleteDto, ILookupTableApplicationService>
    {
