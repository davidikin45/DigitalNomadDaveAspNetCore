...
namespace DND.Web.DynamicForms.MVCImplementation.LookupTables.Controllers
{
    ...
    public class AdminLookupTablesController : BaseEntityControllerAuthorize<LookupTableDto, LookupTableDto, LookupTableDto, LookupTableDeleteDto, ILookupTableApplicationService>
    {
