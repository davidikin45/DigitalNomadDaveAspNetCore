...
namespace DND.Web.DynamicForms.MVCImplementation.Questions.Api
{
    ...
    public class QuestionsController : BaseEntityWebApiControllerAuthorize<QuestionDto, QuestionDto, QuestionDto, QuestionDeleteDto, IQuestionApplicationService>
    {
