...
{
    public abstract class BaseIntegrationTestDbSetup<T> where T : class, IDisposable
    {
        public string DBName { get; }
        public BaseIntegrationTestDbSetup(string MSSQLLocalDBDbNameOrConnectionString)
        {
