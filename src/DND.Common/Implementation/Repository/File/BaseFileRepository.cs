...
namespace DND.Common.Implementation.Repository.File
...
{
    public class BaseFileRepository : BaseFileReadOnlyRepository, IBaseFileRepository
    {
        public BaseFileRepository(string physicalPath, Boolean includeSubDirectories, string searchPattern = "*.*", CancellationToken cancellationToken = default(CancellationToken), params string[] extensions)
