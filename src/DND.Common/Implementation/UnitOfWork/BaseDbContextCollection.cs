...
namespace DND.Common.Implementation.UnitOfWork
{
    ...
    public class BaseDbContextCollection : IBaseDbContextCollection
    {
        ...
        public BaseDbContextCollection(bool readOnly = false, IsolationLevel? isolationLevel = null, IDbContextFactory dbContextFactory = null)
        {
            ...
            _initializedDbContexts = new Dictionary<Type, IBaseDbContext>();
            _transactions = new Dictionary<IBaseDbContext, IBaseDbContextTransaction>();
        ...
        public TIBaseDbContext Get<TIBaseDbContext>() where TIBaseDbContext : IBaseDbContext
        {
            if (_disposed)
                throw new ObjectDisposedException("DbContextCollection");

            var requestedType = typeof(TIBaseDbContext);
