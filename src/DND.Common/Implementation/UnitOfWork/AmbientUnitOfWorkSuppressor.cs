...
namespace DND.Common.Implementation.UnitOfWork
{
    ...
    {
        private UnitOfWorkTransactionScope _savedScope;
        private bool _disposed;

        public AmbientContextSuppressor()
        {
            _savedScope = UnitOfWorkTransactionScope.GetAmbientScope();
            ...
            // is safe.
            UnitOfWorkTransactionScope.HideAmbientScope();
        }
        ...
        public void Dispose()
        {
            ...
            if (_savedScope != null)
            {
                UnitOfWorkTransactionScope.SetAmbientScope(_savedScope);
                _savedScope = null;
            }
