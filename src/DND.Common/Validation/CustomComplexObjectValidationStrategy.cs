...
{
    public class CustomComplexObjectValidationStrategy : IValidationStrategy
    {
        private static readonly bool IsMono = Type.GetType("Mono.Runtime") != null;
        public static readonly IValidationStrategy Instance = new CustomComplexObjectValidationStrategy();

        private CustomComplexObjectValidationStrategy()
        {
        ...
        {
            if (metadata is CustomModelMetadata)
            {
                return GetChildren(((CustomModelMetadata)metadata), key, model);
            }
            else
            {
