...
{
    public class CustomCollectionValidationStrategy : IValidationStrategy
    {
        private static readonly MethodInfo _getEnumerator = typeof(CustomCollectionValidationStrategy)
        ...
        /// </summary>
        public static readonly CustomCollectionValidationStrategy Instance = new CustomCollectionValidationStrategy();
        ...
        private CustomCollectionValidationStrategy()
        {
        }
