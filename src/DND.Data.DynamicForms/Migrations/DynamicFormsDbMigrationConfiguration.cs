...
namespace DND.Data.DynamicForms.Migrations
{
    ...
    public sealed class DynamicFormsDbMigrationConfiguration : BaseDbConfiguration<DynamicFormsDbContext>
    {
        public DynamicFormsDbMigrationConfiguration()
        {
            //Seed(ApplicationDbContext.Create());
            ContextKey = "DND.Data.DynamicForms.Migrations.DynamicFormsDbMigrationConfiguration";
        }
