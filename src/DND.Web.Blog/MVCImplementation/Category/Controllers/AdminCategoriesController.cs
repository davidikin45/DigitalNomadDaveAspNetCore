...
namespace DND.Web.Blog.MVCImplementation.Category.Controllers
{
    [Route("admin/blog/categories")]
    public class AdminCategoriesController : BaseEntityControllerAuthorize<CategoryDto, CategoryDto, CategoryDto, CategoryDeleteDto, ICategoryApplicationService>
    {
