...
namespace DND.Common.Testing
{
    public static class TestHelper
    {
        ...
        public static GenericEFRepository<TEntity> GetRepository<TContext, TEntity>(string connectionString, bool beginTransaction)
        ...
        public static GenericEFRepository<TEntity> GetRepositoryInMemory<TContext, TEntity>(string databaseName = "")
            where TContext : DbContext
            where TEntity : class
        {
