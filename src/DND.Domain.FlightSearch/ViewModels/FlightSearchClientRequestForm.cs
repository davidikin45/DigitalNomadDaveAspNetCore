...
namespace DND.Domain.ViewModels
{
    public class FlightSearchClientRequestForm : ObjectValidatableBase, IMapTo<FlightSearchRequestDto>, IHaveCustomMappings
    {
        ...
        [Required, Display(Name = "Flight Class"), EnumDatasource(Datasource = typeof(FlightSearch.Enums.FlightClass))]
        ...
        [EnumDatasource(Datasource = typeof(FlightSearch.Enums.SortType))]
        public string SortType { get; set; }

        [EnumDatasource(Datasource = typeof(FlightSearch.Enums.SortOrder))]
