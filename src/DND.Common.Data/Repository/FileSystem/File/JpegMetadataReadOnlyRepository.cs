...
{
    public class JpegMetadataReadOnlyRepository : FileReadOnlyRepository, IJpegMetadataReadOnlyRepository
    {

        public JpegMetadataReadOnlyRepository(string physicalPath, Boolean includeSubDirectories, CancellationToken cancellationToken = default(CancellationToken))
