...
{
    public class JpegMetadataRepository : JpegMetadataReadOnlyRepository, IJpegMetadataRepository
    {
        public JpegMetadataRepository(string physicalPath, Boolean includeSubDirectories, CancellationToken cancellationToken = default(CancellationToken))
