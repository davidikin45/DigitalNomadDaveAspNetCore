...
{
    public class UnitOfWorkTransactionScope : UnitOfWorkScopeBase, IUnitOfWorkTransactionScope
    {
        ...
        public UnitOfWorkTransactionScope(IDbContextFactoryProducerSingleton dbContextFactory = null, IAmbientDbContextLocator contextLocator = null, IGenericRepositoryFactory repositoryFactory = null, IDomainEvents domainEvents = null,  CancellationToken cancellationToken = default(CancellationToken)) :
            this(joiningOption: UnitOfWorkScopeOption.JoinExisting, readOnly: false, isolationLevel: null, dbContextFactory: dbContextFactory, contextLocator : contextLocator, repositoryFactory : repositoryFactory, cancellationToken: cancellationToken)
        {}
        ...
        public Task<Result<int>> CompleteAsync()
        {
            return CompleteAsync(CancellationToken.None);
        }

        public async Task<Result<int>> CompleteAsync(CancellationToken cancelToken)
        {
            if (cancelToken == null)
        ...
        private Result<int> HandleEFCoreUpdateAndDeleteConcurrency(DbUpdateConcurrencyException ex)
        {
