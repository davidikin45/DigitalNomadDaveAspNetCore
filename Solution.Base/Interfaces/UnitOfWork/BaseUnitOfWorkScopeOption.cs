...
{
    /// <summary>
    /// Indicates whether or not a new UnitOfWorkScope will join the ambient scope.
    /// </summary>
    public enum BaseUnitOfWorkScopeOption
    {
        /// <summary>
        /// Join the ambient UnitOfWorkScope if one exists. Creates a new
        /// one otherwise.
        /// 
        ...
        /// <summary>
        /// Ignore the ambient UnitOfWorkScope (if any) and force the creation of 
        /// a new UnitOfWorkScope. 
        /// 
