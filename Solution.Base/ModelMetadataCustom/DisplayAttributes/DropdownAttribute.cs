...
namespace Solution.Base.ModelMetadataCustom.DisplayAttributes
{
    public class FolderDropdownAttribute : DropdownAttribute
    {
        public FolderDropdownAttribute(string folderId, Boolean nullable = false)
            : this(folderId, nameof(DirectoryInfo.FullName), nameof(DirectoryInfo.LastWriteTime), Solution.Base.ModelMetadataCustom.DisplayAttributes.OrderByType.Descending, nullable)
        {
    ...
    public class FileDropdownAttribute : DropdownAttribute
    {
        public FileDropdownAttribute(string folderId, Boolean nullable = false)
            : this(folderId, nameof(DirectoryInfo.Name), nameof(DirectoryInfo.LastWriteTime),Solution.Base.ModelMetadataCustom.DisplayAttributes.OrderByType.Descending, nullable)
        {
    ...
    public class DropdownAttribute : Attribute, IMetadataAttribute
    {
        ...
        public DropdownAttribute(Type modelType, string valueProperty)
            :this(modelType, "Id", valueProperty, "Id", Solution.Base.ModelMetadataCustom.DisplayAttributes.OrderByType.Descending)
        {
