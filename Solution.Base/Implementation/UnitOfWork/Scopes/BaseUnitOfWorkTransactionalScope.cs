...
namespace Solution.Base.Implementation.UnitOfWork
{
    public class BaseUnitOfWorkTransactionScope : BaseUnitOfWorkScope, IBaseUnitOfWorkTransactionScope
    {
        ...
        private BaseUnitOfWorkTransactionScope _parentScope;

        public BaseUnitOfWorkTransactionScope(IDbContextFactory dbContextFactory = null, IBaseAmbientDbContextLocator contextLocator = null, IBaseRepositoryFactory repositoryFactory = null, CancellationToken cancellationToken = default(CancellationToken)) :
        ...
        public BaseUnitOfWorkTransactionScope(bool readOnly, IDbContextFactory dbContextFactory = null, IBaseAmbientDbContextLocator contextLocator = null, IBaseRepositoryFactory repositoryFactory = null, CancellationToken cancellationToken = default(CancellationToken))
        ...
        public BaseUnitOfWorkTransactionScope(BaseUnitOfWorkScopeOption joiningOption, bool readOnly, IsolationLevel? isolationLevel, IDbContextFactory dbContextFactory = null, IBaseAmbientDbContextLocator contextLocator = null, IBaseRepositoryFactory repositoryFactory = null, CancellationToken cancellationToken = default(CancellationToken))
             :base(contextLocator: contextLocator, repositoryFactory: repositoryFactory, cancellationToken: cancellationToken)
        {
            ...
            {
                _nested = false;
                _dbContexts = new BaseDbContextCollection(readOnly, isolationLevel, dbContextFactory);
            }
...
" + Environment.StackTrace;
        ...
        private static readonly ConditionalWeakTable<InstanceIdentifier, BaseUnitOfWorkTransactionScope> UnitOfWorkScopeInstances = new ConditionalWeakTable<InstanceIdentifier, BaseUnitOfWorkTransactionScope>();
        ...
        /// </summary>
        internal static void SetAmbientScope(BaseUnitOfWorkTransactionScope newAmbientScope)
        {
        ...
        /// </summary>
        internal static BaseUnitOfWorkTransactionScope GetAmbientScope()
        {
            ...
            BaseUnitOfWorkTransactionScope ambientScope;
