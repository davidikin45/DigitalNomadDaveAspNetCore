...
namespace Solution.Base.Implementation.UnitOfWork
{
    ...
    {
        private BaseUnitOfWorkTransactionScope _savedScope;
        private bool _disposed;

        public AmbientContextSuppressor()
        {
            _savedScope = BaseUnitOfWorkTransactionScope.GetAmbientScope();
            ...
            // is safe.
            BaseUnitOfWorkTransactionScope.HideAmbientScope();
        }
        ...
        public void Dispose()
        {
            ...
            if (_savedScope != null)
            {
                BaseUnitOfWorkTransactionScope.SetAmbientScope(_savedScope);
                _savedScope = null;
            }
